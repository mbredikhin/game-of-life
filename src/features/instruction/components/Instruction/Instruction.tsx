    ...
    >
      ...
      {isDropdownExpanded ? (
        <div ref={dropdownRef} className={styles.content}>
          <span className={styles['content__title']}>How to start?</span>
          <p>
            The universe of the Game of Life is an infinite, two-dimensional orthogonal grid of
            square cells, each of which is in one of two possible states, live or dead (or populated
            and unpopulated, respectively). Every cell interacts with its eight neighbours, which
            are the cells that are horizontally, vertically, or diagonally adjacent. At each step in
          ...
          <p>
            These rules, which compare the behaviour of the automaton to real life, can be condensed
            into the following:
          </p>
          <ol>
          ...
          <p>
            ...
            sometimes called a tick. Each generation is a pure function of the preceding one. The
